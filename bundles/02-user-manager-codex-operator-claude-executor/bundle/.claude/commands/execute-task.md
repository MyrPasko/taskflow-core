...
1. Read `CLAUDE.md`.
2. Read `.taskflow/tasks/$ARGUMENTS/02-packet.md`.
...
5. Update `.taskflow/tasks/$ARGUMENTS/03-notes.md` with short delta notes.
6. Update `.taskflow/tasks/$ARGUMENTS/04-review.md` with verification and risks.
