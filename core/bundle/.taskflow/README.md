...
- `tasks/<task-dir>/01-packet.md`: compact executor packet
- `tasks/<task-dir>/02-notes.md`: implementation notes and deltas
- `tasks/<task-dir>/03-review.md`: review outcome, risks, verification
